...
const CreatePostForm: React.FC = () => {
  ...
  return (
    <form onSubmit={handleSubmit} className="bg-white p-6 rounded-2xl shadow-sm space-y-4">
      <h2 className="text-xl font-poppins font-bold text-neutral-navy">Crea un nuevo post</h2>
      ...
      <button type="submit" disabled={isUploading} className="w-full p-3 text-white rounded-lg bg-primary-purple hover:bg-opacity-90 transition-colors disabled:bg-gray-400">
